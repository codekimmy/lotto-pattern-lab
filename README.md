...
- 본번호 6개만 사용, 보너스 번호 제외
- 직전 55회 출현률에서 최근 5회 출현률을 뺀 급랭 점수
- 급랭 상위 10개를 후보군으로 구성
- 최근 200회 번호쌍 PMI를 계산
- 표준화된 급랭 점수 + 0.5 × 표준화된 번호쌍 점수로 최종 6개 선택
- 최근 30회 3회, 50회 4회, 60회 5회 이상 ‘3개 적중’을 빠른 검증 기준으로 사용
...
- 실전 검증 기간: 신규 20회
- 1차 합격: 3개 이상 적중 2회
- 강한 합격: 3개 이상 적중 3회 이상
- 20회 0회: 중단 후보
- 20회 1회: 보류
- 과거 단기 창: 최근 10회 1회, 20회 2회, 30회 3회
- 공백 경고: 11~15회
- 재검토: 연속 미적중 16회 이상
- 모델 규칙 변경 시 실전 카운터를 0회부터 재시작
